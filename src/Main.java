...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(ans == 'y'){
            ...
            System.out.println(TextParser.findWordsOfGivenLengthInQuestionSentences(text, 4));
        }
        else{
            ...
            System.out.println(TextParser.findWordsOfGivenLengthInQuestionSentences(text, num));
        }
    }
